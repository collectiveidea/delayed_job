...
module Delayed
  module Launcher
    ...
    class Single < Runner
      ...
      def run
        # TODO: set_process_name(get_name(process_identifier))
      ...
      def stop_blocked
        logger.info '- Gracefully stopping, waiting for jobs to finish'
        @worker.stop(true) if @worker
      end
