...
module Delayed
  class Worker
    cattr_accessor :min_priority, :max_priority, :max_attempts, :max_run_time, :default_priority, :sleep_delay, :logger, :delay_jobs, :queues, :read_ahead, :default_queue_name
    self.sleep_delay = 5
    self.max_attempts = 25
    self.max_run_time = 4.hours
    self.default_priority = 0
    self.delay_jobs = true
    self.queues = ENV["QUEUES"] ? ENV["QUEUES"].split(',') : ['local_dev']
    self.read_ahead = 5
