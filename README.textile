...
# Way #2: create an object that responds to perform, and enqueue it
...
# Way #3: call handle_asynchronously after a method declaration, and it
...
For full details on these methods, read on.
